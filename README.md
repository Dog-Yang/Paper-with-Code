...
| 2023 ICCV   | **Perceptual Grouping in Contrastive Vision-Language Models** | [[paper]](https://openaccess.thecvf.com/content/ICCV2023/papers/Ranasinghe_Perceptual_Grouping_in_Contrastive_Vision-Language_Models_ICCV_2023_paper.pdf) <details><summary>[Summary]</summary> Self-supervised pretraining how to deal with patch token: **1.max pooling(this paper choise).** 2.average pooling. 3.cls token. </details>  |
| 2024 arXiv  | **TokenPacker: Efficient Visual Projector for Multimodal LLM** |[[paper]](https://arxiv.org/abs/2407.02392) [[code]](https://github.com/CircleRadon/TokenPacker) <details><summary>[Summary]</summary> Qformer fusion image and text gap. </details>  |
